...
const Payment = () => {
    ...
    const completeAdyenDemoOrder = async (result = adyenResult) => {
        ...
        try {
            ...
            if (!updatedBasket) {
                throw new Error('Add a valid billing address before completing the demo order.')
            }
    ...
    return (
        <ToggleCard
            ...
            isLoading={isCompletingAdyenOrder || billingAddressForm.formState.isSubmitting}
        ...
        >
            <ToggleCardEdit>
                ...
                <Stack spacing={6}>
                    <Text fontSize="sm" color="gray.700">
                        This demo checkout accepts payment through Adyen only. After authorisation,
                        it creates the PWA Kit demo order automatically.
                    </Text>
